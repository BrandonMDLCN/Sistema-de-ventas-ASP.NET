...
$(document).ready(function () {
    ...
    fetch("/Usuario/ListaRoles")
        ...
        .then(responseJason => {
            if (responseJason.length > 0) {
                responseJason.forEach((item) => {
                    $("#cboRol").append(
        ...
        responsive: true,
         ...
         "columns": [
             { "data": "idUsuario","visible":false,"searchable":false },
             {
                 ...
                 {
                     return `<img style="height:60px; max-width: 100%; object-fit:cover;" src=${data} class="rounded mx-auto d-block"/>`
                 }
             },
             { "data": "nombre" },
             { "data": "correo" },
...
$("#btnGuardar").click(function () {
    ...
    //muestra una imagen de cargando    se encuentra en /vendor/loadingoverlay
        ...
        fetch("Usuario/Crear", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    ...
                    //Muestra form con mensaje listo
